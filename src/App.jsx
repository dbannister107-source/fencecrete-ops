...
function Sidebar({page,setPage,jobs,collapsed,setCollapsed,onNavClick,navGroups}){
  ...
  return <>
    <div style={{background:'#FFFFFF',borderBottom:'1px solid rgba(0,0,0,0.08)',display:'flex',alignItems:'center',justifyContent:collapsed?'center':'center',padding:collapsed?'16px 0':'20px 20px 18px',flexShrink:0,boxShadow:'0 1px 0 rgba(0,0,0,0.05)'}}>
