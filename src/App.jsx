...
function BillingPage({jobs,onRefresh,onNav}){
  ...
  const cycleActiveJobs=useMemo(()=>jobs.filter(j=>['in_production','ready_to_install','in_install','active_installation','installation_complete','complete'].includes(j.status)),[jobs]);
