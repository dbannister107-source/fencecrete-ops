...
const SC = { contract_review:'#6B7280', production_queue:'#B45309', in_production:'#7C3AED', material_ready:'#1D4ED8', active_install:'#059669', fence_complete:'#0F766E', fully_complete:'#15803D', closed:'#6B7280', canceled:'#DC2626' };
const SB_ = { contract_review:'#F9FAFB', production_queue:'#FEF3C7', in_production:'#EDE9FE', material_ready:'#DBEAFE', active_install:'#D1FAE5', fence_complete:'#CCFBF1', fully_complete:'#DCFCE7', closed:'#F4F4F2', canceled:'#FEE2E2' };
